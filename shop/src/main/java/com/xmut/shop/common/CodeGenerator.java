...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/shop";
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:postgresql://localhost:5432/RS_system?useUnicode=true&characterEncoding=UTF8&useSSL=false");
